...
(function()
{
    ...
    CodeMirror.defineMode("javascript", function(config, parserConfig) {
      ...
      function jsTokenBase(stream, state) {
        var ch = stream.next();
        //if (ch == '@') {
        //    if (!stream.eat("@") && stream.eatWhile(/[a-z]/i))
        //        return ret("razor", "razor");
        //}
        if (ch == '"' || ch == "'")
      ...
      function maybelabel(type) {
        ...
        var jTypesProperties = ["__base", "__self", "__this", "__type"];

      function property(type, value) {
        if (type == "variable") { cx.marked = jTypesProperties.indexOf(value) >= 0 ? "keyword" : "property"; return cont();}
      }
